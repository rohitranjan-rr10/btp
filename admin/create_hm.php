		...
		<div class="cd-radial-slider-wrapper">
			...
			<div class="main">
				<div id="navigation" style="display:none;" class="w3_agile">
					<ul>
						<li class="selected">
							<a href="#"><i class="fa fa-check" aria-hidden="true" style="color: #22c55e;"></i><span>Appoint</span></a>
						</li>
						<li>
							<a href="#"><i class="fa fa-close" aria-hidden="true" style="color: #ef4444;"></i><span>Remove</span></a>
						</li>
					</ul>
				</div>
				<div id="navigation" style="display:none;" class="w3_agile">
